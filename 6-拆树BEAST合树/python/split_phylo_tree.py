...
def run(
    ...
    for relative in ["target_subtrees", "beast_subtrees", "intermediate"]:
    ...
    write_table([record.to_row() for record in paml_records], PAML_SUMMARY_COLUMNS, output_dir / "beast_subtree_summary.tsv")
    write_table(paml_manifest_rows, PAML_MANIFEST_COLUMNS, output_dir / "beast_tree_manifest.tsv")
