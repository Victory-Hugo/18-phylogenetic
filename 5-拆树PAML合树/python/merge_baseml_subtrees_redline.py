...
def run(
    ...
    write_tsv(graft_rows, ["target_subtree_id", "target_root_node_id", "paml_subtree_id", "analysis_tree_file", "target_nonbackbone_n_tips", "graft_status", "attachment_placeholder", "topology_match", "details"], merge_output_dir / "graft_report.tsv")
    write_tsv(edge_update_rows, ["edge_role", "target_subtree_id", "paml_subtree_id", "node_id", "descendant_tip_hash", "descendant_n_tips", "old_branch_length", "new_branch_length", "aggregation_source", "changed"], merge_output_dir / "edge_update_report.tsv")
    write_tsv(subtree_scale_rows, ["target_subtree_id", "paml_subtree_id", "scale_factor", "shared_paths_n", "median_log_ratio", "residual_mad", "status", "details"], merge_output_dir / "subtree_scale_report.tsv")
    print(
