	seqfile	  =	/mnt/f/onedrive/文档（科研）/脚本/Download/18-phylogenetic/1-Benchmark/data/bench.fasta    * [输入序列文件，此处为模板，请勿修改]
	treefile  =	/mnt/f/onedrive/文档（科研）/脚本/Download/18-phylogenetic/1-Benchmark/data/bench.reroot.tree * [输入树文件，此处为模板，请勿修改]

	outfile	  =	/mnt/f/onedrive/文档（科研）/脚本/Download/18-phylogenetic/1-Benchmark/data/mlb		  * [主结果文件，此处为模板，请勿修改]
	...
	clock 		    = 1  		* 1: 全局分子钟模式 * 0:无分子钟, 1:全局分子钟; 2:局部分子钟; 3:组合分析
