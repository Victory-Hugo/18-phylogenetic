...
frequency of at least 0.5 were drawn as chords. Both the co-clustering frequency
and a feature similarity, defined as one minus the Euclidean distance normalised
by its within-window maximum, were additionally displayed as category-by-category
matrices, with rows and columns kept in a single global order across all windows. The scaled feature matrix of each
